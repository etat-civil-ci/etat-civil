		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
					...
					<!-- Nav item -->
					<li class="nav-item"> <a class="nav-link {{ request()->routeIs('actenaissance') ? 'active' : '' }}" href="{{ route('actenaissance') }}">Acte de naissance</a> </li>

					<!-- Nav item -->
					<li class="nav-item"> <a class="nav-link {{ request()->routeIs('actemariage') ? 'active' : '' }}" href="{{ route('actemariage') }}">Acte de mariage</a> </li>

					<!-- Nav item -->
					<li class="nav-item"> <a class="nav-link {{ request()->routeIs('actedeces') ? 'active' : '' }}" href="{{ route('actedeces') }}">Acte de décès</a> </li>
					<!-- Nav item -->

					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Page</a>
