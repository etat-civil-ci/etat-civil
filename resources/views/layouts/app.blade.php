							...
							<div class="row pt-2">
								<div class="col-sm-6">
									<ul class="list-unstyled">
										<li class="nav-item"> <a class="dropdown-item {{ request()->routeIs('createactenaissance') ? 'active' : '' }}" href="{{ route('createactenaissance') }}">Nouvel Extrait</a> </li>
										<li class="nav-item">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu d">
							<div class="row pt-2">
								<div class="col-sm-6">
									<ul class="list-unstyled">
										<li class="nav-item"> <a class="dropdown-item {{ request()->routeIs('createactemariage') ? 'active' : '' }}" href="{{ route('createactemariage') }}">Nouvel </a> </li>
										<li class="nav-item">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu d">
							<div class="row pt-2">
								<div class="col-sm-6">
									<ul class="list-unstyled">
										<li class="nav-item"> <a class="dropdown-item {{ request()->routeIs('createactedeces') ? 'active' : '' }}" href="{{ route('createactedeces') }}">Nouvel </a> </li>
										<li class="nav-item">
							...
							<div class="row pt-2">
								...
								<div class="col-sm-6">
									<ul class="list-unstyled">
										...
										<li> <a class="dropdown-item" href="{{ route('dash')}}">Dashboard</a> </li>
