...
<section>
	<div class="container pt-4 pt-sm-0">
		...
		<div class="row g-4 g-xxl-5">
			...
			<div class="">
				<!-- Title -->
				<h1 class="mb-0 lh-base">Acte de mariage</h1>
				<p class="mb-0 mt-4">Un acte de mariage peut donner lieu à la délivrance de 2 documents différents : la copie intégrale, l'extrait simple .
					...
					Un extrait simple comporte uniquement les informations sur les époux.</p>
			</div>
			<!-- Hero content END -->
	...
	<div class="container">
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6 ps-md-5">
				<h2 class="mb-4">Comment faire la demande</h2>
				<p class="mb-0">Pour une demande de copie intégrale ou un extrait simple, il faut présenter sa pièce d'identité et une copie de l'extrait de mariage.des frais de timbre (500 F CFA /Copie) sont applicables</p>

				<hr class="my-4">
				<h4 class="mb-4">Mariage civil</h4>
				<h6>Les formalités de mariage</h6>
				<p>Le mariage doit être célébré à la mairie. Toutefois, des exceptions sont prévues. En effet, en cas d'empêchement grave, le procureur de la République pourra demander à l'officier d'état civil de se déplacer au domicile ou à la résidence de l'une des parties pour célébrer le mariage.</p>
				<h6>Le nombre de témoins pour la célébration du mariage</h6>
				<p>La célébration du mariage doit être faite par un officier de l'état civil, à la mairie, en présence de deux témoins.</p>
				<h6>Constituer son dossier de mariage</h6>
				<p>Il faut vous rendre au Service Mariage de la Mairie pour obtenir les documents à fournir et faire la réservation de la date du mariage</p>
