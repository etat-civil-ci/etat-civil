...
<div class="container mt-6">
    <h2 class="text-center mb-4">Formulaire d'Acte de Naissance</h2>
    ...
    <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Entrer le numéro cni" required>
        </div>

        <!-- Nom -->
        <div class="col-md-6">
            <label for="nom" class="form-label">Nom & Prénoms du concerné</label>
            <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrer le nom" required>
        </div>

        <!-- Prénom -->
        <div class="col-md-6">
            <label for="prenom" class="form-label">Télephone</label>
            <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Entrer le contact" required>
        </div>
        ...
        <div class="col-12 text-center">
            <button type="submit" class="btn btn-primary">Enregistrer l'acte de naissance</button>
        </div>
    </form>
</div>
