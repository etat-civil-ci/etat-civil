		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
                    ...
                    <li class="nav-item"> <a class="nav-link active" href="contact-v1.html">Accueil</a> </li>

					<!-- Nav item -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Etats civils</a>
						<div class="dropdown-menu dropdown-menu-size-lg p-3">
							<div class="row pt-2">
								<!-- Image and button -->
								<div class="col-sm-6">
									<ul class="list-unstyled">
										<li> <a class="dropdown-item" href="index.html">Acte de naissance</a> </li>
										<li> <a class="dropdown-item" href="index-creative-agency.html">Acte de Mariage</a> </li>
										<li> <a class="dropdown-item" href="index-digital-agency.html">Acte de Décès</a> </li>
										<li> <a class="dropdown-item" href="index-design-agency.html">Certification de document</a> </li>
										<li> <a class="dropdown-item" href="index-seo-agency.html">Légalisation de signature</a> </li>
									</ul>
								</div>
								...
								<div class="col-12">
									...
									<div class="d-sm-flex justify-content-between align-items-center px-2">
										<div class="me-3 mb-2 mb-sm-0">
											<h6 class="mb-2 mb-sm-0">Pret à commencer ?</h6>
											<small class="mb-0">Faites passer vos documents au niveau supérieur avec état civil</small>
										</div>
										<a href="#" class="btn btn-sm btn-primary">Connecté vous</a>
									</div>
								</div>
							</div>
						</div>
			...
			<ul class="nav align-items-center dropdown-hover ms-sm-2">
				...
				<li class="nav-item me-2 d-none d-sm-block">
					<a href="sign-up.html" class="btn btn-sm btn-light mb-0"><i class="bi bi-person-circle me-1"></i>Se connecter</a>
				</li>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xl-10 text-center mx-auto">
				<!-- Hero title -->
				<span class="font-heading heading-color d-inline-block bg-light px-3 py-2 rounded-3 mb-4">🤩 What Drives Us</span>
				<h1 class="mb-4">À propos de notre plateforme</h1>
				<p class="lead mb-0">Bienvenue sur la plateforme officielle de gestion de l’état civil en ligne.
                    Notre mission est de rapprocher l’administration du citoyen en simplifiant les démarches liées aux actes d’état civil (naissance, mariage, décès, etc.).</p>
				...
				<div class="row g-4 mt-5 mx-auto align-items-end">
					<div class="col-md-5 position-relative">
						...
						<div class="text-end position-relative d-none d-md-block">
							...
							<figure class="position-absolute top-0 start-50 ms-n7">
								<svg class="fill-mode" width="106px" height="96px" viewBox="0 0 106 96" style="enable-background:new 0 0 106 96;" xml:space="preserve">
							...
							<!-- Image -->
							<img src="assets/images/about/16.jpg" class="rounded mb-4 w-50" alt="about-img">
						</div>
					</div>
					...
					<div class="col-md-7 position-relative mb-n4">
						...
						<div class="card card-body bg-dark text-start z-index-2 w-75 p-5 mb-4">
							...
							<h4 class="text-white fw-light mb-0 mt-3">"We believe that it takes great people to deliver a great product"</h4>
						</div>

						<!-- Image -->
						<div class="card card-body overflow-hidden p-0">
							<img src="assets/images/about/15.jpg" class="card-img" alt="about-img">
							<div class="bg-overlay bg-dark opacity-2"></div>
							<!-- Card img overlay -->
							<div class="position-absolute end-0 bottom-0 m-3 z-index-2">
								<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lh btn-white" data-glightbox data-gallery="course-video"><i class="bi bi-youtube text-danger fa-fw fa-xl me-1"></i> Watch our story</a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6 ps-xl-7">
				<h2 class="mb-4">Decouvrez état civil</h2>
				<p>Notre mission est de rapprocher l’administration du citoyen en simplifiant les démarches liées aux actes d’état civil (naissance, mariage, décès, etc.).</p>
				<p>Face aux longues files d’attente, aux délais souvent importants et aux difficultés d’accès pour certains citoyens, cette plateforme numérique offre une solution moderne, rapide et sécurisée.</p>
				<p class="mb-4">citoyen, où qu’il soit, de faire sa demande d’acte en ligne, de payer les frais de timbre en toute sécurité, et de recevoir un document officiel au format PDF signé numériquement.</p>
				<!-- Button -->
...
<section class="pt-0">
	<div class="container">
		<div class="row">
			<!-- Title -->
			<div class="col-md-5">
				<h2 class="mb-5">You have questions we have answers</h2>
			</div>
					...
					<div class="accordion-item mb-3">
						<div class="accordion-header font-base" id="heading-3">
							<button class="accordion-button fw-semibold collapsed rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
								Can I use this theme for my client?
							</button>
						</div>
						<!-- Body -->
					...
					<div class="accordion-item mb-3">
						<div class="accordion-header font-base" id="heading-4">
							<button class="accordion-button fw-semibold collapsed rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
								Do you offer themes in other categories?
							</button>
						</div>
						<!-- Body -->
					...
					<div class="accordion-item mb-3">
						<div class="accordion-header font-base" id="heading-5">
							<button class="accordion-button fw-semibold collapsed rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
								Do I need to credit you when I use this theme?
							</button>
						</div>
						<!-- Body -->
...
<footer class="bg-dark pt-6" data-bs-theme="dark">
	<div class="container position-relative mt-sm-5">
		...
		<div class="row g-3 g-md-4 align-items-center">
			<div class="col-md-6">
				<h2 class="mb-0 lh-base">Get started on your path to
					<span class="position-relative z-index-1">success
						<!-- SVG START -->
			...
			<div class="col-md-5 text-md-end ms-auto">
				<a class="btn btn-lg btn-primary-soft icon-link icon-link-hover mb-0" href="#">Start Your Journey<i class="bi bi-arrow-right"></i> </a>
			</div>
		</div>
		...
		<div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-3">
			...
			<!-- Copyright link-->
			<div class="text-body mt-3 mt-md-0"> Copyrights ©2024 Mizzle. Build by <a href="https://www.webestica.com/" class="text-body text-primary-hover">Webestica</a>. </div>
			<!-- Copyright link-->
		</div>
	</div>
</footer>
...
<!-- Mirrored from mizzle.webestica.com/about-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Apr 2025 16:04:43 GMT -->
</html>