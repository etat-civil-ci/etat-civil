...
<section>
	<div class="container pt-4 pt-sm-0">
		...
		<div class="row g-4 g-xxl-5">
			...
			<div class="">
				<!-- Title -->
				<h1 class="mb-0 lh-base">Acte de décès</h1>
				<p class="mb-0 mt-4">Acte de décès peut donner lieu à la délivrance de 2 documents différents : la copie intégrale, l'extrait simple .
                    ...
                    Un extrait simple comporte uniquement les informations sur la personne concernée par l'acte de décès.</p>
			</div>
			<!-- Hero content END -->
	...
	<div class="container">
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6 ps-md-5">
				<h2 class="mb-4">Déclaration de Décès</h2>
				<p class="mb-0">Comment faire la déclaration de décès</p>
				...
				<div class="row row-cols-1 ">
					<div class="col">
						<ul class="list-group list-group-borderless mb-0">
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Procès-verbal de constations de décès ;</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Une pièce d'identité du defunt(Carte nationale d’identité,extrait de naissance , passeport ou certificat de nationalité )</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Une pièce d'identité du déclarant(Carte nationale d’identité,extrait de naissance , passeport ou certificat de nationalité)</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Copie de l'acte de mariage si le defunt etait marié</li>
                            <li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Copie du de-par-la loi s’il y a lieu <br>Délai : Quinze (15) jours à compter du jour du décès.</li>
						</ul>
					</div>
					{{-- <div class="col">
						<ul class="list-group list-group-borderless mb-0">
				...
				<div class="text-center d-inline-block bg-dark rounded px-5 py-3 mt-4 mt-lg-5">
					<span class="text-white">Avez vous déjà un acte décès?</span> <a class="ms-2" href="{{ route('actedeces')}}">Nouvel acte<span class="bi-chevron-right small ms-1"></span></a>
				</div>
			</div>
		</div> <!-- Row END -->
